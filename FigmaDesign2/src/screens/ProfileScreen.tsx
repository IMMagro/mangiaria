...
function MenuRow({ icon, label, sublabel, danger = false, badge }: MenuItem) {
  return (
    <button className="w-full flex items-center gap-3.5 px-4 py-3.5 active:bg-[#F8F6F2] transition-colors">
