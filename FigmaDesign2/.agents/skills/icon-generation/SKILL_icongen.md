...
description: Generate professional app icons with transparent backgrounds using AI (Google Gemini). Output is a Square PNG with transparent background - ready for app stores, favicons, or UI. Use this skill whenever the user asks to create an icon, favicon, or visual asset for an application.
---
...
**Template:**
`A [STYLE] style icon of [CONCEPT] on a transparent background. Square format, centered, clean edges, suitable for app icon. [COLOR PREFERENCES]. Simple, recognizable, professional.`
